...
if(isset($_POST["register"]))
{
	...
	if($statement->execute($check_data))
	{
		...
		{
			$message .= '<p><label>email sudah terdaftar</label></p>';
		}
		else
		{
			...
			if(empty($type))
			{
				$message .= '<p><label>Type account diperlukan</label></p>';
			}
			else
			{
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form method="post">
						...
						<div class="form-group">
							<input type="radio" name="type" value="" checked hidden><label>Type your account</label><br>
